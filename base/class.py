...
class BombaCombustivel:
    def __init__(self, tipo_combustivel:str, valor_litro: float,quatidade_combustive: float):
        self.valor_litro = valor_litro
        self.tipo_combustivel = tipo_combustivel
        self.quantidade_combustivel = quatidade_combustive
    ...
    def _apresentar_abastecimento_se_possivel(self,litros_abastecidos:float,valor:float):
        if litros_abastecidos > self.quantidade_combustivel:
            ...
            print (f'Sobraram na bomba {self.quantidade_combustivel:.2f} litro de  {self.tipo_combustivel}.')
    ...
    def adicionar_mais_combustivel(self, quantidade:float):
        if quantidade >= 0:
           ...
           print ('Malandro, você não vai rouba meu combustivel dessa bomba')
